  ...
  },
{
  ...
  },
  {
    ...
    description: "Leveraged LinkedIn for B2B real estate branding and lead generation, connecting with professionals and investors through content-driven outreach.",
    category: "social media",
    highlightKeyword: "Real Estate",
  ...
  },
  {
    ...
    description: "Launched Instagram campaigns for a women’s clothing brand, using aesthetic visuals and influencer collaborations to grow brand following and sales.",
    category: "social media",
  ...
  },
  {
    ...
    description: "Used Facebook marketing to build brand presence for a manufacturing company, generating inquiries and showcasing capabilities to industry buyers.",
    category: "social media",
  ...
  },
  {
    ...
    description: "Promoted an online shop through creative TikTok videos, capitalizing on viral trends to increase product visibility and drive youthful traffic.",
    category: "social media",
